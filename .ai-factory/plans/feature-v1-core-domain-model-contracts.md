...
- [ ] Task 5: Replace generic action payloads with a closed agent-command union
...
- [ ] Task 6: Add simulation-owned command admission and request binding
...
- [ ] Task 7: Add private validated world operations and atomic promotion
...
- [ ] Task 8: Define immutable closed world events and transition results
...
- [ ] Task 9: Implement one strict versioned serialization boundary
...
- [ ] Task 10: Enforce public facades, private authority, dependency rules, and exhaustive typing
...
- [ ] Task 11: Close coverage gaps, complete documentation checkpoint, and verify end to end
