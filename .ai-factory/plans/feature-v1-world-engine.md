...
- [x] Task 9: Make `WorldEngine` the sole supported public authority path.
...
- [x] Task 10: Preserve schema-1 compatibility and enforce lifecycle typing/boundaries.
...
- [x] Task 11: Prove deterministic reruns and document the World Engine contract.
