...
- [ ] Task 5: Introduce prepare/persist/finalize tick coordination without weakening `WorldEngine` authority.
...
- [ ] Task 6: Establish the dedicated `persistence` adapter package and enforce dependency rules.
...
- [ ] Task 7: Create the relational schema, append-only database guards, constraints, and query indexes.
...
- [ ] Task 8: Implement atomic SQLAlchemy repositories, idempotency, and concurrent-writer protection.
