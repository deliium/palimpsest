...
- [x] Task 9: Implement the public replay/recovery service and composition API.
...
- [x] Task 10: Prove event projection, transactional coordination, and replay validation in unit tests.
...
- [x] Task 11: Prove PostgreSQL persistence, append-only enforcement, concurrency, and snapshot-plus-event reconstruction end to end.
...
- [x] Task 12: Document the persistence/replay contract and complete all quality gates.
